...
const ChatInterface = ({ selectedChatId, onChatUpdate }: ChatInterfaceProps) => {
  ...
  if (messages.length === 0) {
    return (
      <div className="flex flex-col h-full w-full overflow-hidden">
            ...
            <div className="w-full space-y-4">
              <div className="flex flex-col md:flex-row items-center justify-center gap-2">
                ...
                <Select value={searchType} onValueChange={setSearchType}>
                  <SelectTrigger className="w-full md:w-32 border-capital-blue/30 dark:border-gray-600">
              ...
              {searchType === 'client' && (
                <div className="flex flex-col md:flex-row items-center justify-center gap-2">
                  ...
                  <Select value={clientName} onValueChange={setClientName}>
                    <SelectTrigger className="w-full md:w-48 border-capital-blue/30 dark:border-gray-600">
        ...
        <div className="w-full p-4 md:p-6 bg-gray-50 border-t border-capital-light-blue/30 dark:bg-gray-900 dark:border-gray-600">
          {uploadedFile && (
          ...
          <div className="flex gap-2 items-end w-full">
            <textarea
              ...
              className="flex-1 border border-capital-blue/30 focus:border-capital-blue resize-none rounded-md px-3 py-2 min-h-[40px] max-h-[120px] dark:border-gray-600 dark:bg-gray-800 dark:text-white overflow-hidden"
              style={{ 
                height: 'auto',
                overflowY: inputValue.split('\n').length > 3 || textareaRef.current?.scrollHeight > 120 ? 'auto' : 'hidden'
              }}
              rows={1}
            />
            <Button
              ...
              variant="outline"
              size="icon"
              className="border-capital-blue/30 hover:bg-capital-blue/10 dark:border-gray-600 dark:hover:bg-gray-700 flex-shrink-0"
            >
            ...
            <Button
              ...
              variant="outline"
              size="icon"
              className={`border-capital-blue/30 dark:border-gray-600 flex-shrink-0 ${
            ...
            <Button
              ...
              className="bg-capital-blue hover:bg-capital-dark-blue text-white flex-shrink-0"
            >
  ...
  return (
    <div className="flex flex-col h-full w-full overflow-hidden">
      ...
      <div className="w-full border-t border-capital-light-blue/30 p-4 md:p-6 bg-white dark:bg-gray-900 dark:border-gray-600 flex-shrink-0">
        {uploadedFile && (
          <div className="mb-3 flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
            <span>📄 {uploadedFile.name}</span>
            <button
